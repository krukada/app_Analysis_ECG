...
M_Expressed_Bradycardia = 'Математическое ожидание по всему ряду пульсовых интервалов указывает на Выраженную ' \
                          'Брадикардию. '

SCO_normal_rhythm_veracity = 'Среднеквадратичное отклонение по всему ряду пульсовых интервалов в норме - нормальная ' \
                             'вериабельность ритма (физиологическое явление, ' \
                             'проявляющееся в изменении интервала между ' \
                             'началами двух соседних сердечных циклов). '
...
SCO_rigid_rhythm = 'Среднеквадратичное отклонение по всему ряду пульсовых интервалов указывает на стабильный(' \
                   'ригидный) ритм - стеноз артерии, снабжающая синусовый узел. '
...
normal_amplitude = 'Значение амплитуды в норме - стабильное воздействие симпатического отдела нервной ' \
                   'системы '

not_normal_amplitude = '' \
                       'Значение амплитуды не в норме - нестабильное воздействие симпатического отдела нервной ' \
                       'системы '
...
variation_range_of_normal = 'Значение вариационного размаха (максимальный разброс значений межпульсовых ' \
                            ...
                            'вегетативного гомеостаза (постоянство внутренней среды организма) '
...
ivr_upscale = 'Индекс Вегетатичного равновесия повышен, что свидетельствует о гипертонуса ' \
              ...
              'преобладанием парасимпатического отдела ' \
              'вегетативной нервной системы над симпатическим '
ivr_down = 'Индекс Вегетатичного равновесия понижен, свидетельстует повышению ваготании - ' \
           'преобладанием парасимпатического отдела ' \
           'вегетативной нервной системы над симпатическим '

vpi_normal = 'Вегетативный показатель ритма в норме - вегетативный баланс с точки зрения автономного ' \
             'контура '

vpi_lowered = 'Вегетативный показатель ритма не в норме - вегетативный баланс смещен в сторону ' \
              'преобладания парасимпатического отдела '

vpi_upscale = 'Вегетативный показатель ритма не в норме - вегетативный баланс смещен в сторону ' \
...
Baevsky_Stress_Index_state_of_rest = 'Индекс напряджения Баевского в норме - характеризует степень централизации ' \
                                     'управления ' \
                                     'ритмом (состояние покоя) '

Baevsky_Stress_Index_upscale = 'Индекс напряджения Баевского увеличен ' \
                               '(избыточная активность высших уровней центрального ' \
...
Baevsky_Stress_Index_upscale_pre_infarction_condition = 'Индекс напряджения Баевского увеличен ' \
                                                        '(избыточная активность высших уровней центрального ' \
                                                        'контура) - характеризует степень' \
                                                        ' централизации управления ритмом ' \
                                                        '- отражает прединфарктное состояние '

Baevsky_Stress_Index_upscale_stenocardia = 'Индекс напряджения Баевского увеличен ' \
                                           '(избыточная активность высших уровней центрального ' \
                                           'контура) - характеризует степень ' \
                                           'централизации управления ритмом - отражает стенокардия '
